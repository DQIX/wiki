...
**Game data:** [Party](Party) · [Items](Items) · [Vocation skill trees](Vocation-Skill-Trees) · [Skill panels](Skill-Panels) · [Battle weight tables](Battle-Weight-Tables) · [Level tables](Level-Tables) · [Spell table](Spell-Table) · [Attending characters](Attending-Characters) · [Monsters](Monsters) · [Event battles](Event-Battles) · [Encounters](Encounters) · [Actions](Actions) · [Battle resolution](Battle-Resolution)
